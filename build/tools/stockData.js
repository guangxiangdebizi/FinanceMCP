...
import { InvalidToolInputError, STOCK_MARKET_TYPES, normalizeEnumInput, normalizeFinancialCode, normalizeOptionalDate, normalizeOptionalEnumInput, normalizeOptionalIndicatorList, } from '../utils/inputValidation.js';
    ...
    async run(args) {
        try {
            ...
            args = {
                ...
                timeframe: normalizeOptionalEnumInput(args.timeframe, ['daily', 'weekly', 'monthly'], 'timeframe'),
            };
