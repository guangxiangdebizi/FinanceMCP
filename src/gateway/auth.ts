...
import { GatewayIdentity, ResolvedGatewayConfig } from './types.js';
...
export function authenticateRequest(req: Request, config: ResolvedGatewayConfig): GatewayIdentity {
